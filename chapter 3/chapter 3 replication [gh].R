...
t1 <- "C:/Dropbox/false alarm/replication data and code/chapter 3/study 1 table.RDS" %>% 
  readRDS
...
t2 <- "C:/Dropbox/false alarm/replication data and code/chapter 3/study 2 table.RDS" %>% 
  readRDS
...
# figure 4.3
t4 <- "C:/Dropbox/false alarm/replication data and code/chapter 3/study 3 table.RDS" %>% 
  readRDS
...
t5 <-  "C:/Dropbox/false alarm/replication data and code/chapter 3/study 4 table.RDS" %>% 
  readRDS
...
t6 <- "C:/Dropbox/false alarm/replication data and code/chapter 3/study 5.RDS"  %>%
  readRDS
