...
t2 <- "C:/Dropbox/false alarm/replication data and code/chapter 4/s_2_t.rds" %>% 
  readRDS
...
t3 <- "C:/Dropbox/false alarm/replication data and code/chapter 4/s_3_t.rds" %>% 
  readRDS
...
ggplot() +
  geom_point(
    aes(date, perc, color = ans),
    data = t3[[1]]
  ) +
  geom_step(
    aes(date, smu, color = ans),
    data = t3[[1]] %>% 
      na.omit
  ) +
  geom_point(
...
t1 <- "C:/Dropbox/false alarm/replication data and code/chapter 4/s_4_t.rds" %>% 
  readRDS
